 ...
 */
final class Version20240314173002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD stock_dispo DOUBLE PRECISION NOT NULL, CHANGE stock_produit_id stock_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP stock_dispo, CHANGE stock_id stock_produit_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27A17D8957 FOREIGN KEY (stock_produit_id) REFERENCES stock (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
